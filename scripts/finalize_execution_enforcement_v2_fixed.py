...
WORKFLOWS_TO_REMOVE = {
    "apply-evaluator-terminal-receipts.yml",
    "apply-execution-enforcement-v2.yml",
    "apply-execution-enforcement-v2-retry.yml",
    "apply-execution-enforcement-v2-phase2.yml",
    "apply-execution-enforcement-v2-phase3.yml",
    "apply-execution-enforcement-v2-phase4.yml",
    "apply-execution-enforcement-v2-phase5.yml",
    "apply-execution-enforcement-v2-phase6.yml",
    "finalize-execution-enforcement-v2.yml",
    "repair-distribution.yml",
    "verify-execution-enforcement-v2.yml",
    "verify-outcome-director-fast.yml",
    "verify-outcome-director.yml",
    "verify-outcome-stack.yml",
}

SCRIPTS_TO_REMOVE = {
    "apply_execution_enforcement_v2.py",
    "repair_apply_execution_v2.py",
    "apply_execution_enforcement_v2_phase2.py",
    "repair_phase2_and_apply.py",
    "apply_execution_enforcement_v2_phase3.py",
    "apply_execution_enforcement_v2_phase4.py",
    "repair_phase4_and_apply.py",
    "apply_execution_enforcement_v2_phase5.py",
    "repair_phase5_and_apply.py",
    "apply_execution_enforcement_v2_phase6.py",
    "patch_outcome_stack_verification.py",
    "finalize_execution_enforcement_v2.py",
}
...
def main() -> None:
    ...
    for name in WORKFLOWS_TO_REMOVE:
        remove(workflows / name)
    (workflows / "ci.yml").write_text(PERMANENT_CI, encoding="utf-8")

    scripts = ROOT / "scripts"
    for name in SCRIPTS_TO_REMOVE:
        remove(scripts / name)

    references = ROOT / "skills/company-os/mission-execution-control/references"
    for name in REFERENCES_TO_REMOVE:
        remove(references / name)

    print("permanent execution enforcement tree prepared")
