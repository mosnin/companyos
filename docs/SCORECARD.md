...
| Change safety | 8.5 | Existing changed installs reject by default; staged replacement has rollback. |
| Test strength | 9.0 | Repository, 98-controller, 10-observation, validator, and compile gates. |
...
| Provider identity and telemetry | Not observed |
