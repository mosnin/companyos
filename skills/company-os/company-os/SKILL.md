...
| Strategy and portfolio | Decide what matters and what stops | `$strategy-pillar`, `$portfolio-direction`, `$economics-architect` |
...
sizing, or market structure, also send `$economics-architect`. Do not send
`$economics-architect` to workers or use it as the master persona.
