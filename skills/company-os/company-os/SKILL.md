...
| Commercial and customer | Connect discovery, adoption, sales, support, and retention to decisions | `$commercial-customer-system`, `$sales-architect` |
...
or closing, also send `$sales-architect`. Do not send `$sales-architect` to
