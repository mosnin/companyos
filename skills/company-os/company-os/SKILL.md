...
| Commercial and customer | Connect discovery, adoption, sales, support, and retention to decisions | `$commercial-customer-system`, `$marketing-architect` |
...
advertising, or growth lifecycle, also send `$marketing-architect`. Do not
send `$marketing-architect` to workers or use it as the master persona.
