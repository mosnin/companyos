#!/usr/bin/env python3
"""Feature-off reference verifier for Company OS Gate 2 observations.

This module performs no provider calls and writes no files.  It verifies one
signed observation and returns a candidate in-memory inbox state.  Canonical
controller integration is a later, separately accepted slice.
"""
